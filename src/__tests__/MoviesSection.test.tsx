...
// Even though it was not in the assignment, it is always good to make tests :)
// I created once simple test to mock API get request for the movies

jest.mock("axios");
//This is made in order to use mockImplementationOnce in TS with axios
const mockedAxios = axios as jest.Mocked<typeof axios>;

describe("Test movies get request", () => {
